...
public class DepartamentoDAO {
    ...
    private PreparedStatement selectProfDep = null;
    ...
    private DepartamentoDAO() throws ClassNotFoundException, SQLException {
        ...
        selectProfDep = conexao.prepareStatement("select departamento.nome, professor.nome from trabalha join professor on mat_prof = matricula join departamento on dep_num = numero");
    }
    ...
    public List<Object> EstDepartamento() throws SelectException {
    	List<Object> lista = new ArrayList<Object>();
    	
  	  try {
  		  ResultSet rs = selectProfDep.executeQuery();
  		  ...
  		  throw new SelectException("Professor de um departamento");
  	  }
  	  return lista;
    }
    
    public List<Object> ProfDepartamento() throws SelectException {
    	List<Object> lista = new ArrayList<Object>();
