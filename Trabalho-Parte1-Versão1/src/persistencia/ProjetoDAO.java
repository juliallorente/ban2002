...
public class ProjetoDAO {
    ...
    public void insert(Projeto projeto) throws SelectException, InsertException {
        ...
        try {
            ...
            insert.setDate(4, projeto.getData_inicio()); //arrumar o setData
            insert.setDate(5, projeto.getData_final());
    ...
    public void update(Projeto projeto) throws UpdateException {
        ...
        try {          
            ...
            update.setDate(3, projeto.getData_inicio()); //arrumar o setData
            update.setDate(4, projeto.getData_final());
    ...
    public Projeto select(int numero) throws SelectException {
        ...
        try {
            ...
            if(rs.next()){
                ...
                Date data_incio = rs.getDate(4); //arrumar o get
                Date data_final = rs.getDate(5);
