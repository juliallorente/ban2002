...
public class Sistema {
	...
	//----------------------------Professor----------------------------//
	public void insereProfessor(Professor usuario) throws SelectException, InsertException{
		professorDAO.insert(usuario);
	}
	public void deletaProfessor(Professor usuario) throws DeleteException {
		professorDAO.delete(usuario);
	}
	public void atualizaProfessor(Professor usuario) throws UpdateException {
		professorDAO.update(usuario);
	}
	public Professor buscaProfessor(int matricula) throws SelectException {
		return professorDAO.select(matricula);
	}
	public List<Professor> buscaProfessor() throws SelectException{
