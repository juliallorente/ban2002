...
public class Professor {
	...
	public Professor(int matricula, String nome, int idade, String sala, String especialidade) {
		super();
...
//string to string
	...
	public String toString() {
		return "Professor [matricula=" + matricula + ", nome=" + nome + ", idade=" + idade + ", sala=" + sala
